...
import { registerSchema, loginSchema, updateProfileSchema, toggleTwoFactorSchema, forgotPasswordSchema, resetPasswordSchema, verifyOtpSchema } from "../validators/authValidators.js";
...
router.route("/verify-otp").post(authLimiter,validate(verifyOtpSchema),verifyLoginOtp); // verify emailed OTP to finish logging in (2FA)

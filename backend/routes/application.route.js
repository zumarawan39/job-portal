...
router.route("/apply/:id").get(isAuthenticated, applyJob); // job seeker applies to a job
router.route("/get").get(isAuthenticated, getAppliedJobs); // job seeker sees jobs they applied to
